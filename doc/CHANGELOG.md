...
- 0.23.x: [0.23.0](#0230-2026-04-23), [0.23.1](#0231-2026-08-03)
...
## 0.21.2 (2026-04-02)
- Updated dependencies.
- Unpinned `undici` as `discord.js` updated.

[:arrow_up: Back to top](#changelog)

## 0.21.1 (2026-03-16)
- Pin `undici` sub-dependency to 6.24.0 to resolve 5 CVEs.
- Updated dependencies.
